...
#define W_CLK PA0   //  - connect to AD9850 module word load clock pin (CLK)
#define FQ_UD PA1   //  - connect to freq update pin (FQ)
#define DATA  PA2   //  - connect to serial data load pin (DATA)
#define RESET PA3   //  - connect to reset pin (RST)
