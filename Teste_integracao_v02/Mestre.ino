  ...
  int comandoserial = Serial.read();
   ...
   switch (comandoserial) {
    ...
    case '2': // 125Khz 24 pontos (24pts = 5 ciclos)
      ...
      wire_envia_byte(0X51,2); // Avisando eletrodo1 da nova frequencia
    ...
    case '3': // 100Khz 12 pontos (12 pts = 2 ciclos)
      ...
      wire_envia_byte(0X51,3); // Avisando eletrodo1 da nova frequencia
    ...
    case '4': // 50Khz 24 pontos (24 pts = 2 ciclos)
      ...
      wire_envia_byte(0X51,4); // Avisando eletrodo1 da nova frequencia
